    ...
    return (
        <div className="info">
            <article className="intro">
                ...
                Aquí, te encontrarás a robots con personalidades encantadoras, seres de todas las galaxias y humanos intrépidos. Futurama es un crisol de posibilidades creativas, donde la extravagancia se combina con una tecnología avanzada y habitantes únicos que hacen de ella un lugar emocionante y lleno de sorpresas.
                <br></br>
                <br></br>
